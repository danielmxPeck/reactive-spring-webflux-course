...
class FluxAndMonoGeneratorServiceTest {
    ...
    void namesFlux_flatMap_defaultIfEmpty() {
        var nameFLux_flatMap_defaultIfEmpty = fluxAndMonoGeneratorService.namesFlux_flatMap_defaultIfEmpty();
    ...
    void explore_zip1() {
        ...
        StepVerifier.create(explore_zip1)
    ...
    void explore_zipWith_mono() {
        ...
        StepVerifier.create(explore_zipWith_mono)
                .expectNext("AD")
                .verifyComplete();
    }
}